...
function increment() {
	...
	{
		document.getElementById("gameOver").innerText = "You won the game! Amogh dominates the Earth!"
	}
}
...
function buyWhite() {
	...
	if (apples >= steveJobsCost) {
		...
		document.getElementById("showApplesPerClick").innerText = applesPerClick;
alert("JESSE IM FREEEE")
	}	else { // if there enough apples
		alert("JESSE! This is not enough.")
	}
}
function whiteTalk() {
  alert("JESSE WHAT ARE YOU DOING")
  var walterspeak = prompt("answer ME JESSE..... WHAT IS THE CODE")
  if(walterspeak === "your mom") {
    alert("hohohohohohoh ok JESSE")
    alert("the code was who I was with last night")
    alert("great that you know..........")
  } 
  else{
    alert("GODDAMMIT JESSE why would you do this")
     window.location.href="INCORECT.html";
